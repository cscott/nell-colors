...
define(['domReady!', './src/color', './src/compat', './src/coords', './src/dom', './src/iscroll', './src/slider'], function(document, Color, Compat, Coords, Dom, iScroll, Slider) {
    'use strict';
...
function pageLoaded() {
  ...
  var updateThumbFromEvent = function(event) {
    ...
    var coords = Coords.getRelativeEventPosition(event, wheel);
